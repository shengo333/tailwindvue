                ...
                <ul class="text-sm mt-6 hidden md:block" id="menu">
                    <li class="text-gray-700 font-bold py-1">
                        <a href="#" class="px-4 flex justify-end ">
                            <router-link to="/" active-class="text-red-500"> Home </router-link> 
                    ...
                    <li class="py-1">
                        <a href="#" class="px-4 flex justify-end ">
                            <router-link to="/about" active-class="text-red-500">About </router-link>
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li class="text-mammoth py-1">
                        <a href="#" class="px-4 flex justify-end">
                            <router-link to="/contact" active-class="text-red-500"> <span>Contact</span> </router-link>
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
